...
Namespace SOUpdate
    Public Class clsAddon
        ...
        Public objProdOrder As ClsProdOrder
        ...
        Public HWKEY() As String = New String() {"L1653539483", "P0118981670", "D0872452844"}
        ...
        Public Sub Intialize(ByVal args() As String)
            Try
                ...
                If isValidLicense() Then
                    ...
                    If HANA Then
                        IndSapUser = objglobalmethods.getSingleValue("select ""U_IndSAPUser"" from OUSR where ""USER_CODE""='" & objaddon.objcompany.UserName & "' and ifnull(""U_IndSAPUser"",'')<>''")
                    ...
                    Else
                        IndSapUser = objglobalmethods.getSingleValue("select U_IndSAPUser from OUSR where USER_CODE='" & objaddon.objcompany.UserName & "'")
                    ...
                    End If
                    oCompany = objProdOrder.ConnectToCompany(IndSapUser, IndSapPass)
...
#Region "Form Data event"
        Private Sub objApplication_FormDataEvent(ByRef pVal As SAPbouiCOM.BusinessObjectInfo, ByRef BubbleEvent As Boolean) Handles objapplication.FormDataEvent
            Try
                ...
                Select Case pVal.FormTypeEx
                    Case "65211"
                        objProdOrder.FormDataEvent(pVal, BubbleEvent)
