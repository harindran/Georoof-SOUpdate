Namespace SOUpdate
    ...
    Public Class clsTable
        ...
        Public Sub FieldCreation()
            ...
            'AddFields("ORDR", "OrderTracking", "Order Tracking", SAPbobsCOM.BoFieldTypes.db_Alpha, 50, , , "", , {"Production Order Created,Production Order Created", "Prod. Order Released,Prod. Order Released"})
            AddFields("OUSR", "IndSAPUser", "Indirect SAP User", SAPbobsCOM.BoFieldTypes.db_Alpha, 30)
            AddFields("OUSR", "IndSAPPass", "Indirect SAP Pass", SAPbobsCOM.BoFieldTypes.db_Alpha, 30)

            'AddFields("OWOR", "clubbing", "Clubbing", SAPbobsCOM.BoFieldTypes.db_Numeric, 10)
            'AddFields("OWOR", "machname", "machname", SAPbobsCOM.BoFieldTypes.db_Alpha, 30)
            'AddFields("OWOR", "SubTable", "SubTable", SAPbobsCOM.BoFieldTypes.db_Numeric, 10)
            'AddFields("OWOR", "Sequence", "Sequence", SAPbobsCOM.BoFieldTypes.db_Alpha, 30)
            'AddFields("OWOR", "AltQty", "AltQty", SAPbobsCOM.BoFieldTypes.db_Float, 10, SAPbobsCOM.BoFldSubTypes.st_Quantity)
            'AddFields("OWOR", "AltQty1", "AltQty1", SAPbobsCOM.BoFieldTypes.db_Float, 10, SAPbobsCOM.BoFldSubTypes.st_Quantity)

            'AddFields("ORDR", "ClubNo", "Club No", SAPbobsCOM.BoFieldTypes.db_Numeric, 10)
            ''AddFields("ORDR", "SO_MachineAllocated", "SO_MachineAllocated", SAPbobsCOM.BoFieldTypes.db_Alpha, 30)
            'AddFields("ORDR", "SubTable", "SubTable", SAPbobsCOM.BoFieldTypes.db_Numeric, 10)
            ''AddFields("ORDR", "Sequence", "Sequence", SAPbobsCOM.BoFieldTypes.db_Alpha, 30)
            ''AddFields("RDR1", "AltQty3", "AltQty3", SAPbobsCOM.BoFieldTypes.db_Alpha, 30)
            ''AddFields("RDR1", "altqty", "altqty", SAPbobsCOM.BoFieldTypes.db_Alpha, 30)
            ''AddFields("ORDR", "ClubNo", "Club No", SAPbobsCOM.BoFieldTypes.db_Alpha, 30)

            'AddFields("RDR1", "altqty", "altqty", SAPbobsCOM.BoFieldTypes.db_Float, 10, SAPbobsCOM.BoFldSubTypes.st_Quantity)
            'AddFields("RDR1", "AltQty3", "AltQty3", SAPbobsCOM.BoFieldTypes.db_Float, 10, SAPbobsCOM.BoFldSubTypes.st_Quantity)
